...
def convert_aac_to_flac(input_file):
...
if __name__ == "__main__":
    ...
    input_aac_file = r"C:\Users\DELL\PYTHON PROJECTS\audio_con\AAC\AAC_To_FLAC\sample1.aac"

    # Check if the file exists before conversion
    if os.path.exists(input_aac_file):
        # Convert AAC to FLAC
        convert_aac_to_flac(input_aac_file)
    else:
